...
public class MyProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myGender = (TextView)view.findViewById(R.id.myGymLocation);
        myName = (TextView)view.findViewById(R.id.myName);
        myGymLocation = (TextView)view.findViewById(R.id.myGymLocation);
        myExerciseField = (TextView)view.findViewById(R.id.userExerciseField);
        myExperience = (TextView)view.findViewById(R.id.userExperience);
        myAge = (TextView)view.findViewById(R.id.userAge);
        myFt = (TextView)view.findViewById(R.id.userFt);
        myIn = (TextView)view.findViewById(R.id.myIn);
        myWeight = (TextView)view.findViewById(R.id.userWeight);
        myBio = (TextView)view.findViewById(R.id.userBio);
